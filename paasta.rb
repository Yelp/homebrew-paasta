class Paasta < Formula
  ...
  desc "Yelp's system for building, deploying, and running services"
  homepage "https://github.com/Yelp/paasta"
  ...
  head "https://github.com/Yelp/paasta.git"
